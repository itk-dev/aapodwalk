...
function Cards({ lat, long, handleExperienceClick }) {
  ...
  const experiences = [
    {
      name: "Halloween på DOKK1",
      id: 1,
      x: 56.153249691363776,
      y: 10.214202802135777,
    },
    {
      name: "Eventyr i dyrehaven",
      x: 56.12287382586223,
      y: 10.218102110686793,
    },
    {
      name: "Fortællinger om domkirken",
      x: 56.156999232502145,
      y: 10.21090265635068,
    },
  ];
        ...
        >
          ...
          <div className="py-20 flex flex-col justify-between leading-normal">
            <div>
              ...
              {getProximity(x, y) && (
                <span className="text-white">{getProximity(x, y)} Meter</span>
              )}
            </div>
          </div>
        </div>
